...
class BaseTestGraphItem(GraphicsObject):
...
# copy from pyqtgraph/Node.py NodeGraphicsItem
# minor change
class BorderGraphItem(BaseTestGraphItem):
    def __init__(self, node):
        BaseTestGraphItem.__init__(self,node)
        self.nameItem.setTextInteractionFlags(QtCore.Qt.TextInteractionFlag.NoTextInteraction)
...
class BaseMiddleGraphNode(Node):
    def __init__(self,name):
        Node.__init__(self,name,allowRemove=False)
    
    def graphicsItem(self):
        if self._graphicsItem is None:
            self._graphicsItem = BaseTestGraphItem(self)
        return self._graphicsItem
    


class BorderGraphNode(Node):
    def __init__(self,name):
        Node.__init__(self,name,allowRemove=False)
    
    def graphicsItem(self):
        if self._graphicsItem is None:
            self._graphicsItem = BorderGraphItem(self)
        return self._graphicsItem
